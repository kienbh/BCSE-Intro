...
export const equipmentCategories: EquipmentCategory[] = [
  {
    ...
    items: [
      { name: 'Máy in 3D (FDM)', count: 4, specs: 'PLA/PETG/TPU/ABS · 3 tại Hòa Lạc, 1 tại Mỹ Đình' },
      { name: 'Máy cắt Laser CO2', count: 1, specs: 'gỗ/acrylic/giấy' },
      { name: 'Máy khoan bàn', count: 1 },
    ],
