...
export const services: ServiceItem[] = [
  ...
  },
  {
    id: 'compass',
    name: {
      vi: 'BCSE Compass — La bàn học tập',
      en: 'BCSE Compass — Learning Navigator',
      ja: 'BCSE Compass — 学習ナビ',
    },
    description: {
      vi: 'La bàn cá nhân sau khi đăng nhập BCSE ID: theo dõi tiến độ tín chỉ, gợi ý định hướng chuyên ngành, bản đồ hành trình 4 năm, launcher tới các cổng và Hỏi đáp trực tiếp (Live Q&A).',
      en: 'Your personal navigator after signing in with BCSE ID: credit progress, specialisation suggestions, a 4-year journey map, a launcher to every portal, and Live Q&A.',
      ja: 'BCSE ID でログイン後の個人ナビ：単位進捗、専攻の提案、4年間のジャーニーマップ、各ポータルへのランチャー、ライブ Q&A。',
    },
    features: {
      vi: ['Tiến độ & định hướng đọc từ BCSE Tracker', 'Bản đồ hành trình 4 năm + launcher các cổng', 'Live Q&A theo phiên (QR, hỏi ẩn danh)', 'Đăng nhập một lần bằng BCSE ID (SSO)'],
      en: ['Progress & track read from BCSE Tracker', '4-year journey map + portal launcher', 'Session-based Live Q&A (QR, anonymous)', 'Single sign-on via BCSE ID'],
      ja: ['BCSE Tracker から進捗・適性を取得', '4年間のジャーニーマップ + ランチャー', 'セッション型ライブ Q&A（QR・匿名）', 'BCSE ID による SSO'],
    },
  ...
  },
  {
    ...
    id: 'wellbeing-chat',
    name: {
      vi: 'Kokoro — Góc thư giãn & dễ ngủ',
      en: 'Kokoro — Relax & Sleep Corner',
      ja: 'Kokoro — リラックス＆快眠コーナー',
    },
    description: {
      vi: 'Góc thư giãn của sinh viên VJU (心 — kokoro). Vào ẩn danh ngay không cần tài khoản: hít thở có dẫn nhịp, âm thanh dễ ngủ, câu cổ nhân mỗi ngày. Đăng nhập BCSE để đua vận động healthy cùng bạn bè.',
      en: 'A relaxation corner for VJU students (心 — kokoro). Jump in anonymously — no account needed: guided breathing, sleep-friendly ambient sounds, a daily quote to ponder. Sign in with BCSE to join friendly activity challenges.',
      ja: 'VJU 学生のためのリラックスコーナー（心 — kokoro）。アカウント不要で匿名利用：ガイド付き呼吸法、快眠アンビエントサウンド、毎日の名言。BCSE ログインで運動チャレンジにも参加可能。',
    },
    features: {
      vi: [
        'Vào ẩn danh ngay — không cần đăng nhập',
        'Hít thở 5 kỹ thuật, có dẫn nhịp + tự ghi giọng dẫn',
        'Sound mixer: mưa, lửa, lofi… + hẹn giờ tắt nhạc',
        'Đăng nhập BCSE: đua vận động, tâm sự ẩn danh',
      ],
      en: [
        'Anonymous access — no login required',
        '5 guided breathing techniques + record your own voice cue',
        'Sound mixer: rain, fire, lofi… with sleep timer',
        'BCSE sign-in unlocks activity challenges & peer board',
      ],
      ja: [
        '匿名ですぐ利用 — ログイン不要',
        'ガイド付き呼吸法 5 種＋自分の声で誘導録音',
        'サウンドミキサー：雨・焚き火・lofi…＋スリープタイマー',
        'BCSE ログインで運動チャレンジ＆匿名掲示板',
      ],
    },
  ...
  },
  {
    ...
    description: {
      vi: 'Cổng theo dõi học tập của cố vấn BCSE — rà soát tín chỉ theo khung đúng khóa (152 TC khóa 2025 về trước · 135 TC từ khóa 2026), cảnh báo nguy cơ tốt nghiệp muộn, dự đoán định hướng chuyên sâu, tư vấn đăng ký kỳ tới và xuất phiếu cố vấn PDF.',
      en: "BCSE advisor dashboard — audits credits against each cohort's curriculum (152 up to 2025 intakes · 135 from 2026), flags at-risk students, predicts specialisation tracks, recommends next-semester courses, and exports PDF advising reports.",
      ja: 'BCSE 学習指導員向けダッシュボード — 入学年度に応じた課程(〜2025:152単位/2026〜:135単位)で修得状況を監査し、リスク学生を検出、専攻適性を予測、次学期の履修提案と PDF 指導報告書を出力。',
    },
    features: {
      vi: ['Rà soát tích lũy theo khung đúng khóa (152/135)', 'Cảnh báo rủi ro tốt nghiệp', 'Dự đoán định hướng chuyên sâu', 'Xuất phiếu cố vấn PDF'],
      en: ['Per-cohort graduation audit (152/135)', 'Graduation risk radar', 'Specialisation track predictor', 'PDF advising reports'],
      ja: ['入学年度別の単位監査(152/135)', '卒業リスク検出', '専攻適性予測', 'PDF 指導報告書'],
    },
  ...
  },
  {
    id: 'bcse-world',
    name: {
      vi: 'BCSE World — Campus ảo 2D',
      en: 'BCSE World — 2D Virtual Campus',
      ja: 'BCSE World — 2D バーチャルキャンパス',
    },
    description: {
      vi: 'Không gian campus VJU 2D để gặp gỡ và giao lưu — di chuyển avatar, trò chuyện video/mic theo từng khu, kết nối senpai–kohai (đàn anh dẫn dắt đàn em) và tổ chức sự kiện cộng đồng.',
      en: 'A 2D VJU campus to meet and mingle — move your avatar, talk via video/mic by zone, connect senpai–kohai (seniors mentoring juniors), and host community events.',
      ja: '2D の VJU キャンパスで出会い交流 — アバターで移動し、ゾーン別にビデオ/マイクで会話、先輩・後輩をつなぎ、コミュニティイベントを開催。',
    },
    features: {
      vi: [
        'Campus 2D nhập vai, di chuyển avatar',
        'Gặp mặt & hỏi đáp video/mic theo từng khu',
        'Senpai–kohai: đàn anh dẫn dắt đàn em',
        'Điểm hẹn cộng đồng & sự kiện trực tuyến',
      ],
      en: [
        'Walk-around 2D campus with avatars',
        'Zone-based video/mic meet & Q&A',
        'Senpai–kohai mentoring',
        'Community meetups & online events',
      ],
      ja: [
        'アバターで歩き回る 2D キャンパス',
        'ゾーン別のビデオ/マイク交流・Q&A',
