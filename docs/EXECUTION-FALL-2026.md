...
- [~] **D12 · Gói tuần định hướng** — ✅ draft (25/8): `docs/onboarding-2026/goi-dinh-huong.html` + `.pdf` (A4 2 trang: trang 1 poster/slide QR sv08 + 4 bước; trang 2 checklist 5 việc có ô tick, QR id.bcse-vju.com, ghi chú hỗ trợ). 🧑‍🏫 **chờ thầy duyệt nội dung** (đặc biệt: tên bài Arena "Hello BCSE" là placeholder — cần khớp bài nhập môn thật ở A1; email hỗ trợ để bh.kien@vju.ac.vn). *DoD: tài liệu in được* — đạt.
